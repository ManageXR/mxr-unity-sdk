...
namespace MXR.SDK.Protocol.Tests {
    public class FrameCodecTests {
        ...
        [Test]
        public void TryDecode_EmptyBuffer_ReturnsTruncatedFrame() {
        ...
        [Test]
        public void TryDecode_PartialLengthPrefix_ReturnsTruncatedFrame() {
        ...
        [Test]
        public void TryDecode_ZeroLengthBody_ReturnsZeroLengthBody() {
            ...
            Assert.AreEqual(FrameCodec.LengthPrefixSize, result.BytesConsumed);
        }

        [Test]
        public void TryDecode_OversizeDeclaredLength_ReturnsOversizeWithoutAllocatingBody() {
            // 64 MiB + 1
            var buffer = new byte[] { 0x04, 0x00, 0x00, 0x01 };
        ...
        [Test]
        public void TryDecode_PartialBody_ReturnsTruncatedFrame() {
        ...
        [Test]
        public void TryDecode_AtMaxBodyLengthPrefix_WithPartialBody_ReturnsTruncated() {
